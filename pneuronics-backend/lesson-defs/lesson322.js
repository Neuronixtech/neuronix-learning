module.exports = {
  ...
  "blocks": [
    ...
    },
    {
      ...
      "type": "heading",
      "data": {
        "textEn": "Calling a Static Method: Class or Instance",
        "textKn": "ಒಂದು Static Method ಕರೆಯುವುದು: Class ಅಥವಾ Instance"
      }
    },
    {
      "id": "sm-concept",
      "type": "concept",
      "data": {
        "headingEn": "Both ways work identically",
        "headingKn": "ಎರಡೂ ಮಾರ್ಗಗಳು ಒಂದೇ ರೀತಿ ಕೆಲಸ ಮಾಡುತ್ತವೆ",
        "bodyEn": "Since a static method doesn't use self, it can be called either through the class name directly (Employee.greet()) or through any instance (emp.greet()) -- both give the exact same result, because no object data is involved either way.",
        "bodyKn": "ಒಂದು static method self ಬಳಸದ ಕಾರಣ, ಇದನ್ನು class ಹೆಸರಿನ ಮೂಲಕ ನೇರವಾಗಿ (Employee.greet()) ಅಥವಾ ಯಾವುದೇ instance ಮೂಲಕ (emp.greet()) ಕರೆಯಬಹುದು -- ಎರಡೂ ನಿಖರವಾಗಿ ಅದೇ ಫಲಿತಾಂಶ ನೀಡುತ್ತವೆ, ಏಕೆಂದರೆ ಯಾವುದೇ ರೀತಿಯಲ್ಲಿ object ಡೇಟಾ ಒಳಗೊಂಡಿಲ್ಲ."
      }
    },
    {
      "id": "sm-code",
      "type": "code",
      "data": {
        "headingEn": "Calling greet() via the class name and via an instance",
        "headingKn": "class ಹೆಸರು ಮೂಲಕ ಮತ್ತು ಒಂದು instance ಮೂಲಕ greet() ಕರೆಯುವುದು",
